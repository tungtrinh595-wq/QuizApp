					...
					<li>
						...
						>
							...
							<span className="block">
								...
								<span className="flex items-center gap-2 text-gray-500 dark:text-gray-400 text-theme-xs">
									<span>Project</span>
					...
					<li>
						...
						>
							...
							<span className="block">
								...
								<span className="flex items-center gap-2 text-gray-500 dark:text-gray-400 text-theme-xs dark:text-gray-400">
									<span>Project</span>
									<span className="w-1 h-1 bg-gray-400 rounded-full"></span>
									<span>8 min ago</span>
								</span>
